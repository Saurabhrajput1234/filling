...
function ThemeToggleInner() {
  ...
  if (!isHydrated) {
    return (
      ...
      >
        ...
        {/* Sun Icon */}
        <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-white shadow-lg transition-all duration-300 translate-x-1">
  ...
  return (
    ...
    >
      ...
      {/* Sun Icon */}
      <span className={`inline-flex h-8 w-8 items-center justify-center rounded-full bg-white shadow-lg transition-all duration-300 ${
